        ...
        <div class="container">
            ...
            <div class="footer-grid">
                ...
                <div class="footer-column">
                    <h4 class="footer-column-title">Hızlı Menü</h4>
                    <div class="footer-links">
                        <a href="<?php echo esc_url(home_url('/')); ?>" class="footer-link">Ana Sayfa</a>
                        <a href="#menu" class="footer-link">Menümüz (₺200–₺800)</a>
                        <a href="#categories" class="footer-link">Et & Balık Çeşitleri</a>
                        <a href="#about" class="footer-link">Hakkımızda & Deneyim</a>
                        <a href="#reservation" class="footer-link">Masa Rezervasyonu</a>
                        <a href="https://maps.app.goo.gl/q2icLBRX1FJNzVtY7" target="_blank" class="footer-link">Yol Tarifi Al (Google Maps)</a>
                    </div>
                </div>
            ...
            <div class="footer-trust">
                ...
                <div class="trust-badge">
                    ...
                    <span>Mama Sandalyesi & Aile Dostu</span>
                </div>
                <div class="trust-badge">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
