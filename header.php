...
<head>
    ...
    <link rel="preload" as="style" href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&family=Playfair+Display:ital,wght@0,600;0,700;0,800;1,400&display=swap">
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&family=Playfair+Display:ital,wght@0,600;0,700;0,800;1,400&display=swap" rel="stylesheet" media="print" onload="this.media='all'">
    <noscript>
...
<div id="page" class="site-wrapper">
    ...
    <div class="site-header-wrapper" id="siteHeaderWrapper">
        <!-- Üst Bilgi Barı (Denfora + Beyzade) - Masaüstünde görünür, mobilde gizlenir -->
        <div class="top-bar">
    ...
    ?>
        ...
        <div class="header-inner">
            ...
            <div class="header-actions">
                ...
                <a href="https://wa.me/<?php echo esc_attr($whatsapp); ?>?text=<?php echo rawurlencode('Merhaba Beyzade Restaurant, masa rezervasyonu ve menü hakkında bilgi almak istiyorum.'); ?>" class="btn btn-whatsapp btn-sm header-whatsapp" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp İletişim">
