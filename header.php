...
<div id="page" class="site-wrapper">
    ...
    <div style="background: var(--color-black); color: #cbd5e1; font-size: 12px; padding: 6px 0; border-bottom: 1px solid rgba(255,255,255,0.08);">
        <div class="container" style="display: flex; align-items: center; justify-content: space-between; flex-wrap: wrap; gap: 8px;">
            ...
            <div style="display: flex; align-items: center; gap: 14px;">
                <span style="color: #f59e0b; font-weight: 700;">★ 4.3 (448 Google Yorumu)</span>
                <span style="color: #475569;">|</span>
                <a href="tel:<?php echo esc_attr($clean_phone); ?>" style="color: #ffffff; font-weight: 700;">
        ...
        <div class="header-inner">
            ...
            <a href="<?php echo esc_url(home_url('/')); ?>" class="header-logo" rel="home">
                <div style="display: flex; flex-direction: column;">
                    <span style="font-size: 24px; font-weight: 900; letter-spacing: -0.02em; color: var(--color-black); line-height: 1.1;">
                        BEYZADE
                    </span>
                    <span style="font-size: 11px; font-weight: 800; text-transform: uppercase; letter-spacing: 0.18em; color: var(--color-primary);">
                        ET & BALIK RESTAURANT
                    </span>
                </div>
            </a>
            ...
            <nav class="header-nav" aria-label="<?php esc_attr_e('Ana Navigasyon', 'mis360'); ?>">
                ...
                <a href="#categories" class="nav-link">
                    <?php esc_html_e('Et & Balık Çeşitleri', 'mis360'); ?>
                </a>
                ...
                <a href="#contact" class="nav-link">
                    <?php esc_html_e('İletişim & Yol Tarifi', 'mis360'); ?>
                </a>
            </nav>

            <!-- Header Actions -->
            <div class="header-actions">
                <!-- WhatsApp Butonu (Doğrudan 0546 503 31 32 Hattına Bağlı) -->
                <a href="https://wa.me/<?php echo esc_attr($whatsapp); ?>?text=<?php echo rawurlencode('Merhaba Beyzade Restaurant, rezervasyon/sipariş hakkında bilgi almak istiyorum:'); ?>" class="btn btn-whatsapp btn-sm header-whatsapp" target="_blank" rel="noopener noreferrer">
    ...
    <div class="mobile-nav-overlay" id="mobileNavOverlay">
        <nav class="mobile-nav" id="mobileNav">
            <div class="mobile-nav-header">
                <div>
                    <span style="font-size: 20px; font-weight: 900; color: var(--color-black);">BEYZADE</span>
                    <div style="font-size: 11px; color: var(--color-primary); font-weight: 700;">ET & BALIK RESTAURANT</div>
                </div>
            ...
            <div class="mobile-nav-body">
                ...
                <a href="#menu" class="mobile-nav-link"><?php esc_html_e('Menümüz (₺200–₺800)', 'mis360'); ?></a>
                <a href="#categories" class="mobile-nav-link"><?php esc_html_e('Et & Balık Çeşitleri', 'mis360'); ?></a>
