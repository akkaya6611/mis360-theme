...
function mis360_render_schema_jsonld(): void {
    ...
    $restaurant_schema = [
        ...
        'image'                  => [
            '<?php echo get_template_directory_uri(); ?>/assets/img/demo/banner-4-BEYZADE.png',
        ...
        'logo'                   => '<?php echo get_template_directory_uri(); ?>/assets/img/demo/cropped-Basliksiz-1-1.png',
        'address'                => [
            '@type'           => 'PostalAddress',
    ...
    if (is_single()) {
        ...
        $article_schema = [
            ...
            'image'            => $thumb ?: '<?php echo get_template_directory_uri(); ?>/assets/img/demo/restaurant.jpg',
            ...
            'publisher'        => [
                ...
                'logo'  => [
                    '@type' => 'ImageObject',
                    'url'   => '<?php echo get_template_directory_uri(); ?>/assets/img/demo/cropped-Basliksiz-1-1.png'
                ]
            ]
        ];
...
function mis360_seo_resource_hints(): void {
    if (is_front_page()) {
        ...
        echo '<link rel="preload" as="image" href="<?php echo get_template_directory_uri(); ?>/assets/img/demo/banner-4-BEYZADE.png" fetchpriority="high">' . "\n";
    }
}
