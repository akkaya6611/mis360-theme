...
function mis360_render_schema_jsonld(): void {
    ...
    $restaurant_schema = [
        ...
        'image'                  => [
            'https://beyzadeetbalikrestaurant.com.tr/wp-content/uploads/2026/05/banner-4-BEYZADE.png',
        ...
        'logo'                   => 'https://beyzadeetbalikrestaurant.com.tr/wp-content/uploads/2026/05/cropped-Basliksiz-1-1.png',
        'address'                => [
            '@type'           => 'PostalAddress',
    ...
    if (is_single()) {
        ...
        $article_schema = [
            ...
            'image'            => $thumb ?: 'https://beyzadeetbalikrestaurant.com.tr/wp-content/uploads/2026/05/restaurant.jpg',
            ...
            'publisher'        => [
                ...
                'logo'  => [
                    '@type' => 'ImageObject',
                    'url'   => 'https://beyzadeetbalikrestaurant.com.tr/wp-content/uploads/2026/05/cropped-Basliksiz-1-1.png'
                ]
            ]
        ];
...
function mis360_seo_resource_hints(): void {
    if (is_front_page()) {
        ...
        echo '<link rel="preload" as="image" href="https://beyzadeetbalikrestaurant.com.tr/wp-content/uploads/2026/05/banner-4-BEYZADE.png" fetchpriority="high">' . "\n";
    }
}
