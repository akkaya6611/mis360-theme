...
function mis360_render_schema_jsonld(): void {
    ...
    if (is_single()) {
        ...
        $article_schema = [
            ...
            'image'            => $thumb ?: get_template_directory_uri() . '/assets/img/demo/restaurant.webp',
            ...
            'publisher'        => [
                ...
                'logo'  => [
                    '@type' => 'ImageObject',
                    'url'   => get_template_directory_uri() . '/assets/img/demo/cropped-Basliksiz-1-1.webp'
                ]
            ]
        ];
...
function mis360_seo_resource_hints(): void {
    if (is_front_page()) {
        ...
        echo '<link rel="preload" as="image" href="' . get_template_directory_uri() . '/assets/img/demo/banner-4-BEYZADE.webp" fetchpriority="high">' . "\n";
    }
}
